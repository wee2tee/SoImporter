...
namespace DotNetDBF
{
    public enum NativeDbType :byte
    {
        ...
        Binary = (byte)0x48, //H in ASCII this is dummy value by WeeTee orginal is B(0x42)
        //Binary = (byte) 0x42, //B in ASCII
        Char = (byte) 0x43, //C in ASCII
        Date = (byte) 0x44, //D in ASCII
        //Float = (byte) 0x48, //H in ASCII this is dummy value by WeeTee original is F
